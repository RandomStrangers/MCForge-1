...
namespace MCForge {
    ...
    public static class ChatTokens {
        ...
        public static List<ChatToken> Standard = new List<ChatToken>() {
            ...
            new ChatToken("$irc1", "IRC1 server and channels", TokenIRC1),
            new ChatToken("$irc2", "IRC2 server and channels", TokenIRC2),
        ...
        static string TokenIRC2(Player p) { return Server.Config.IRCServer2 + " > " + Server.Config.IRCChannels2; }
        static string TokenIRC1(Player p) { return Server.Config.IRCServer1 + " > " + Server.Config.IRCChannels1; }
