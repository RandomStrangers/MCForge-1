...
using MCForge.Core;
using MCForge.Modules.Moderation.Notes;
...
using MCForge.Modules.Relay2.IRC2;
using MCForge.Modules.Relay2.Discord2;
using MCForge.Modules.Security;
using MCForge.Scripting;

namespace MCForge 
{
    /// <summary> This class provides for more advanced modification to MCForge </summary>
    public abstract class Plugin 
    {
        ...
        /// <summary> Oldest version of MCForge this plugin is compatible with. </summary>
