...
namespace MCForge.Modules.Relay1 
{
    ...
    public abstract class RelayBot1 
    {
        ...
        protected void HandleDirectMessage(RelayUser1 user, string channel, string message) {
        ...
        protected void HandleChannelMessage(RelayUser1 user, string channel, string message) {
            if (IgnoredUsers.CaselessContains(user.ID)) return;
            message = ParseMessage(message).TrimEnd();
            if (message.Length == 0) return;
        ...
        protected virtual void MessagePlayers(RelayPlayer1 p) {
        ...
        protected bool CanUseCommand(RelayUser1 user, string cmd, out string error) {
            error = null;
        ...
        protected sealed class RelayPlayer1 : Player {
