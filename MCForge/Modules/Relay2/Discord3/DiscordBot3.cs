...
using MCForge.Events.GroupEvents;
...
{
    public sealed class DiscordBot3 : RelayBot2 
    {
        ...
        public override void LoadControllers() {
            Controllers = PlayerList.Load("text/discord3/controllers.txt");
        }
        ...
        protected override void MessagePlayers(RelayPlayer2 p) {
