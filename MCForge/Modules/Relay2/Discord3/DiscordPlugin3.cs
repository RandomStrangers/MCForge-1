...
using MCForge.Events.ServerEvents;
...
namespace MCForge.Modules.Relay2.Discord3 
{
    public sealed class Discord3Config 
    {
        ...
        const string PROPS_PATH = "properties/discordbot3.properties";
    ...
    public sealed class DiscordPlugin3 : Plugin 
    {
        ...
        public override string MCForge_Version { get { return Server.Version; } }
        public override string name { get { return "DiscordRelay3"; } }
        
        public static Discord3Config Config = new Discord3Config();
        public static DiscordBot3 Bot2 = new DiscordBot3();
        ...
        public override void Unload(bool shutdown) {
            ...
            Bot2.Disconnect("Disconnecting Discord bot");
        }
        
        void OnConfigUpdated() { Bot2.ReloadConfig(); }
    }
    
    public sealed class CmdDiscordBot3 : RelayBotCmd2 
    {
        public override string name { get { return "DiscordBot3"; } }
        protected override RelayBot2 Bot { get { return DiscordPlugin3.Bot2; } }
    }
    
    public sealed class CmdDiscordControllers3 : BotControllersCmd2 
    {
