...
namespace MCForge.Modules.Relay2 
{
    ...
    public abstract class RelayBot2 
    {
        ...
        protected void HandleDirectMessage(RelayUser2 user, string channel, string message) {
        ...
        protected void HandleChannelMessage(RelayUser2 user, string channel, string message) {
            if (IgnoredUsers.CaselessContains(user.ID)) return;
            message = ParseMessage(message).TrimEnd();
            if (message.Length == 0) return;
        ...
        protected virtual void MessagePlayers(RelayPlayer2 p) {
        ...
        protected bool CanUseCommand(RelayUser2 user, string cmd, out string error) {
            error = null;
        ...
        protected sealed class RelayPlayer2 : Player {
