...
namespace MCForge {
    public sealed partial class Server {
        ...
        public static Scheduler MainScheduler = new Scheduler("MCF_MainScheduler");
        public static Scheduler Background = new Scheduler("MCF_BackgroundScheduler");
        public static Scheduler Critical = new Scheduler("MCF_CriticalScheduler");
