...
namespace MCForge {
    public sealed class ServerConfig : EnvConfig {
        ...
        [ConfigString("server-name", "Server", "[MCForge] Default", false, " !\"#$%&'()*+,-./:;<=>?@[\\]^_`{|}~")]
        public string Name = "[MCForge] Default";
        ...
        [ConfigString("irc-nick2", "IRC bot2", "ForgeBot1")]
        ...
        [ConfigString("irc-opchannel1", "IRC bot2", "#changethistoo2", true)]
